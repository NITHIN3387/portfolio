...
const Projects = () => {
  const projects = [
    {
      ...
      details:
        "Built a government grievance website with Next.js, Tailwind, Node.js, Express.js, and Firebase. It automates problem submission to relevant departments using a Naive Bayes algorithm. Utilizes image metadata to identify the problem`s location.",
    ...
    },
    {
      ...
      details:
        "A stunning LinkedIn clone frontend built entirely with React Native and powered by React Navigation.",
      laptopView: null,
    ...
    },
    {
      ...
      details:
        "a full-stack recipe sharing application developed using React, Node.js, and MongoDB. This project showcases my skills in web development, database management, and user authentication.",
    ...
    },
    {
      ...
      skills: ["ReactJs", "Bootstrap", "NodeJs", "ExpressJs", "MongoDB"],
      details:
        "My MERN stack inventory system offers real-time updates, streamlined stock tracking, and seamless workflow integration, enhancing efficiency and accuracy. Empower your organization with improved productivity and optimized inventory management.",
  ...
  return (
    <div className=" relative ps-5 flex flex-col justify-center">
      <div className="absolute sm:text-[10em] text-[6em] top-0 right-0 font-extrabold text-white/5">
        Projects
      </div>
      ...
      <div
        className="flex gap-10 mx-5 overflow-x-scroll w-[calc(100vw-80px)] snap-x snap-mandatory"
        data-carousel="slide"
      >
